...
- Active phase: **Phase 3 — Adaptive Auto-Layout** (`docs/roadmap.md`). Planning audit **PASSED WITH ARCHITECTURAL REFINEMENTS**; sprint map **APPROVED**. DND-3.1 Auto-Layout **contract** COMPLETE ([auto-layout-contract.md](./auto-layout-contract.md), [ADR-0014](../adr/ADR-0014-auto-layout-enrichment-provenance.md)). DND-3.2 Core placement engine **COMPLETE** as **INTERNAL**. DND-3.3 Core stability / adaptive reflow **COMPLETE** as **INTERNAL** ([auto-layout-engine.md](./auto-layout-engine.md)). **Next:** DND-3.4 Drag / Partial Intent / DOM-React DX (not started).
...
**Technical MVP:** CLOSED · **Public Alpha:** LIVE · **Phase 3:** ACTIVE (DND-3.1 + DND-3.2 + DND-3.3 COMPLETE; DND-3.4 NEXT)
...
See [auto-layout-engine.md](./auto-layout-engine.md) for the DND-3.2/DND-3.3 INTERNAL Core placement + stability/reflow engine.
