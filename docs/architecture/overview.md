...
- **Framework Expansion Gate** is **ACTIVE** (unnumbered; **not** Phase 4). **DND-FX.1–FX.4 COMPLETE.** DND-FX.5 is **NEXT** (not started). See [framework-expansion-planning-audit.md](./framework-expansion-planning-audit.md), [framework-adapter-contract.md](./framework-adapter-contract.md).
...
**Technical MVP:** CLOSED · **Public Alpha:** LIVE (`0.1.0-alpha.1` / `@alpha`) · **Phase 3:** COMPLETE / RELEASED · **Framework Expansion:** ACTIVE (DND-FX.1–FX.4 COMPLETE; DND-FX.5 NEXT)
