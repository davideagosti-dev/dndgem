...
- Drag/drop interaction and React/vanilla product bindings remain later sprints.

See [core-domain.md](./core-domain.md) for domain, scoring, and solver semantics.
See [dom-adapter.md](./dom-adapter.md) for DOM measurement and resize observation (ADR-0011).
