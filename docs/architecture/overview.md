...
- **Framework Expansion Gate** is **ACTIVE** (unnumbered; **not** Phase 4). **DND-FX.1–FX.2 COMPLETE.** DND-FX.3 Angular is **NEXT** (not started). See [framework-expansion-planning-audit.md](./framework-expansion-planning-audit.md), [framework-adapter-contract.md](./framework-adapter-contract.md).
...
**Technical MVP:** CLOSED · **Public Alpha:** LIVE (`0.1.0-alpha.1` / `@alpha`) · **Phase 3:** COMPLETE / RELEASED · **Framework Expansion:** ACTIVE (DND-FX.1–FX.2 COMPLETE; DND-FX.3 NEXT)
...
@dndgem/dom
     ▲
     │
@dndgem/react   (+ in-repo unpublished `@dndgem/vue`; planned: angular, svelte)
```
...
- Billing / cloud SaaS
- Vue / Angular / Svelte implementations (Framework Expansion Gate — Vue is DND-FX.2 COMPLETE, in-repo unpublished; Angular/Svelte remain later sprints)
