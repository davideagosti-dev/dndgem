...
- Phase 2 — Public Alpha Readiness is **PASS** / Public Alpha **LIVE**. Official npm `@alpha`: **`0.1.0-alpha.4`**. (Phase 4 surface; Phase 3 Auto-Layout was `0.1.0-alpha.1`; Cross-Framework recovery was `0.1.0-alpha.3`; first Alpha was `0.1.0-alpha.0`; `0.1.0-alpha.2` is superseded).
...
- **Framework Expansion Gate** is **COMPLETE** (unnumbered; **not** Phase 4). **DND-FX.1–FX.6 COMPLETE.** Shipped as **`0.1.0-alpha.3` / `@alpha`**. See [framework-expansion-planning-audit.md](./framework-expansion-planning-audit.md), [framework-adapter-contract.md](./framework-adapter-contract.md).
- **Phase 4 — AI-Assisted Layout Intelligence** is **COMPLETE AND SHIPPED** in **`0.1.0-alpha.4`** (DND-4.1–DND-4.5). Does **not** require an LLM. DND-4.2 / DND-4.3 public surfaces published on npm `@alpha`; model assistance **deferred until new evidence**; `@dndgem/intelligence*` remain private. See [phase-4-planning-audit.md](./phase-4-planning-audit.md), [layout-intelligence-contract.md](./layout-intelligence-contract.md), [ADR-0018](../adr/ADR-0018-layout-intelligence-boundary.md), [advisory-planner.md](../guides/advisory-planner.md), [0.1.0-alpha.4](../releases/0.1.0-alpha.4.md).
...
**Technical MVP:** CLOSED · **Public Alpha (npm):** LIVE (`0.1.0-alpha.4` / `@alpha`) · **Phase 3:** COMPLETE / RELEASED · **Framework Expansion:** COMPLETE (DND-FX.1–FX.6) · **Phase 4:** COMPLETE AND SHIPPED (`0.1.0-alpha.4`)
...
- Default model-assisted layout (Phase 4 — **COMPLETE AND SHIPPED** in `0.1.0-alpha.4`; model assistance **deferred**; optional advisory planner seam published)
- Billing / cloud SaaS
- Vue / Angular / Svelte implementations (Framework Expansion Gate — **COMPLETE**; shipped as `0.1.0-alpha.3`)
- Flutter implementation (separate track)
- Custom native DnD engine
- Public `@dndgem/intelligence` / `@dndgem/intelligence-openai` packages (private reference only)
