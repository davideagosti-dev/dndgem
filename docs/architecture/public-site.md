...
`homepage` / `bugs` in `@dndgem/*` package.json point at `https://dndgem.dev`. Published npm `@alpha` (`0.1.0-alpha.4`) carries current DA62 / `dndgem.dev` metadata. Historical `0.1.0-alpha.0` tarballs are unchanged.
