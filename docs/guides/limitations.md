...
| Auto-Layout            | Core engine INTERNAL (DND-3.2/DND-3.3); **not** wired for React/Vanilla consumers yet (DND-3.4) | [Auto-Layout engine](../architecture/auto-layout-engine.md) |
