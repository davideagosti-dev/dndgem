...
| npm packages               | Published `@alpha` `0.1.0-alpha.4`; install with `@alpha` only                                                                                                                        | Post-Phase-4 / [0.1.0-alpha.4](../releases/0.1.0-alpha.4.md)              |
...
| Auto-Layout                | Opt-in on `@alpha` (`0.1.0-alpha.4`); default off                                                                                                                                     | [Auto-Layout engine](../architecture/auto-layout-engine.md)               |
| Advisory planner           | Optional; advisory order only; no guaranteed improvement; no DOM/a11y reordering; no automatic model inference; published in `0.1.0-alpha.4`                                          | [Advisory Planner](./advisory-planner.md)                                 |
...
| Vue / Angular / Svelte     | Published on `@alpha` (`@dndgem/vue`, `@dndgem/angular`, `@dndgem/svelte` at `0.1.0-alpha.4`)                                                                                         | Framework Expansion Gate (DND-FX.6 COMPLETE)                              |
