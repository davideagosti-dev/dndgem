...
| Auto-Layout            | Wired in repository / next Alpha (DND-3.4; opt-in). Published `0.1.0-alpha.0` does **not** include it yet | [Auto-Layout engine](../architecture/auto-layout-engine.md) |
