...
| npm packages               | Published `@alpha` `0.1.0-alpha.3`; prepared source `0.1.0-alpha.4` (not published yet); install with `@alpha` only                                                                   | DND-FX.6 / Post-Phase-4                                                   |
...
| Auto-Layout                | Opt-in on `@alpha` (`0.1.0-alpha.3` published; source preparing `0.1.0-alpha.4`); default off                                                                                         | [Auto-Layout engine](../architecture/auto-layout-engine.md)               |
| Advisory planner           | Optional; advisory order only; no guaranteed improvement; no DOM/a11y reordering; no automatic model inference; prepared in source `0.1.0-alpha.4`                                    | [Advisory Planner](./advisory-planner.md)                                 |
