...
This installs Public Alpha **`0.1.0-alpha.3`** via dist-tag **`alpha`**. Always use `@alpha` — do not treat bare installs / `latest` as a stable channel (`latest` still points at historical `0.1.0-alpha.0`). See [release notes](../releases/0.1.0-alpha.3.md).
