...
Current published Alpha (`0.1.0-alpha.1` / `@alpha`) remains `@dndgem/core`, `@dndgem/dom`, and `@dndgem/react` only. Do **not** `npm install @dndgem/angular`. Use this workspace until DND-FX.6.
