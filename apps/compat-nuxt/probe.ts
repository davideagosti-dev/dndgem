export const NUXT_PROBE_KEY = '__DNDGEM_META_NUXT' as const;
...
export function ensureProbe(): CompatProbe {
  ...
  const holder = window as unknown as Record<typeof NUXT_PROBE_KEY, CompatProbe | undefined>;
  holder[NUXT_PROBE_KEY] ??= emptyProbe();
  return holder[NUXT_PROBE_KEY];
}
